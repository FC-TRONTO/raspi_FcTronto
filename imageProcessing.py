...
class ImageProcessing:
    ...
    def imageProcessingFrame(self, shmem, stream):
        # HSV色空間に変換
        ...
        # 壁の検知
        self.colorDetect(hsv_img, self.WALL_HSV_RANGE_MIN, self.WALL_HSV_RANGE_MAX, 'Wall')
        ...
        with picamera.PiCamera() as camera:
            with picamera.array.PiRGBArray(camera) as stream:
                ...
                while cap.isOpened():
                    ...
                    self.imageProcessingFrame(shmem, stream)
